...
export const frameworkSteps: FrameworkStep[] = [
  {
    ...
    output: { icon: FileText, label: "Business & Workflow Assessment" },
  },
  {
    no: "02",
    navLabel: "Strategise",
    ...
    icon: Map,
    description:
      "We turn the findings into a clear plan, ranking the changes that deliver the most value for the least effort.",
    points: [
      "Opportunity scoring & prioritisation",
      "Transformation roadmap",
      "Quick wins & phased delivery plan",
      "Solution design & tooling choices",
      "Budget, timeline & resourcing",
      "Success metrics & KPIs",
    ],
    output: { icon: ClipboardList, label: "Prioritised Transformation Roadmap" },
  },
  {
    no: "03",
    navLabel: "Build",
    ...
    icon: Database,
    description:
      "We build the systems, automations and AI solutions your business needs to run efficiently.",
    points: [
      "Custom software development",
      "Cloud database & data centralisation",
      "Workflow & document automation",
      "AI agents, chatbots & copilots",
      "Website & customer portals",
      "Data security & access control",
    ],
    output: { icon: Zap, label: "Working Systems, Automations & AI" },
  },
  {
    no: "04",
    navLabel: "Integrate",
    ...
    icon: Plug,
    description:
      "We connect the new solutions to your existing systems and to the people who use them every day.",
    points: [
    ...
    output: { icon: Plug, label: "Connected Systems & Confident Teams" },
  },
  {
    no: "05",
    navLabel: "Grow",
    ...
    points: [
      ...
      "Quarterly review & improvement cycles",
    ],
